...
namespace PruebaSTJuanTrejo.Migrations
{
    ...
    [Migration("20230503172203_CustomerFields")]
            ...
            modelBuilder.Entity("PruebaSTJuanTrejo.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ad31c6bb-4f37-415f-9a96-36721e7d2750"),
            ...
            modelBuilder.Entity("PruebaSTJuanTrejo.Entities.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3039bac4-4520-49b0-ba88-7d94f80c5faf"),
                            Code = "ABC1234567",
            ...
            modelBuilder.Entity("PruebaSTJuanTrejo.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("991433ff-f7d0-46ee-af9a-be6c379c733f"),
                            Address = "Dirección de prueba",
                            Branch = "Rama A"
                        });
                });
